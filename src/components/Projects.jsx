            ...
            <div className="projects--entries">
                <div className="projects--entry" data-aos="fade-up">
                    <img src="" alt="" />
                        ...
                        <h3>2022</h3>
                        <p className="projects--p">Partify is web app that models a user's music taste from data fetched via Spotify's API and recommends matching events and venues. Partify is not online as of this writing, but you can read about it here.</p>
